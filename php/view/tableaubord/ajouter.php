  ...
  <div id="mail-app" class="section">
    <div class="row">
      <div class="col s12 m12 l12">
        <h4 class="header2">Ajout Sc&eacute;nario</h4> <br>
        <div class="row">
          <form class="col s12" id="monForm">
            ...
            <div class="row">
              <div class="input-field col s12">
                ...
                <button class="btn green waves-effect waves-light right" type="submit" id="showHidden" name="action">Suivant</button>
              </div>
            </div>
          </form>
        </div>
        <div class="row" id="detailsContainer" hidden="">
          <div class="col s12 m12 l12">
